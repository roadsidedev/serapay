...
function activityErrorCopy(error: unknown) {
  ...
  if (/failed query|sera_api_credentials|column .* does not exist|relation .* does not exist/i.test(message)) return "Activity storage needs the latest Pocket Sera database migration. Apply the current production migration, then try again.";
